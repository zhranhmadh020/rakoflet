...
def main(page: Page):
    ...
    dayin = TextField(label="يوم", helper_text="اخر يوم", color=colors.BLUE_50,
                      bgcolor=colors.BLACK45, icon=icons.TODAY, width=110, height=60)
    monthin = TextField(label="شهر", helper_text="اخر شهر", color=colors.BLUE_50,
                        bgcolor=colors.BLACK45, width=80, height=60)
    yearin = TextField(label="سنة", helper_text="اخر سنة", color=colors.BLUE_50,
                       bgcolor=colors.BLACK45, width=80, height=60)
    ...
    f = ElevatedButton(text="احسب باقي كام يوم", bgcolor=colors.BLUE, width=230,
                       height=60, icon=icons.SUMMARIZE, icon_color="green300",
                       on_click=calculate)
